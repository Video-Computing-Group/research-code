...
#ifndef __LOOPY_SAVE_TIME__
#define __LOOPY_SAVE_TIME__

class LoopySTime : public InferenceAlgorithm {

  /**
     This class makes inference using Loopy Belief Propagation algorithm,
     in mode of saving time but wasting space for the messages
 ...
 public:
  ...
  // ctor
  LoopySTime(MRF const* mrf, SumOrMax m = MAX, Strategy s = SEQUENTIAL,
