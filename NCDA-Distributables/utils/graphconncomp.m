function [s,c]=graphconncomp(G,varargin)
...
if directed && ~weak
    if nargout>1
        [s,c] = graphalgs('scc',debug_level,directed,G);
    else
        s = graphalgs('scc',debug_level,directed,G);
    end
else
    if nargout>1
        [s,c] = graphalgs('wcc',debug_level,directed,G);
    else
        s = graphalgs('wcc',debug_level,directed,G);
    end
end
